-- Gap Analysis Feature: RPC Functions
-- Two functions to power the gap analysis feature:
-- 1. get_zip_gap_analysis: Returns aggregate data for red circles on map
-- 2. get_zip_opportunity_details: Returns detailed competitor data for drawer
