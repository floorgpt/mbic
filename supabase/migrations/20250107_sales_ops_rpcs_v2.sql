...
-- V2: Drops existing functions first to avoid conflicts
...
drop function if exists public.sales_ops_category_kpis(date, date);
drop function if exists public.sales_ops_category_kpis_monthly(date, date);
drop function if exists public.sales_ops_kpis_by_collection(date, date);
drop function if exists public.sales_ops_kpis_monthly_by_collection(date, date);
drop function if exists public.sales_ops_collection_by_dealer(text, date, date);
drop function if exists public.sales_ops_fill_rate(date, date);
drop function if exists public.sales_ops_import_lead_time(date, date);
drop function if exists public.sales_ops_forecast_accuracy(date, date);
drop function if exists public.sales_ops_inventory_turnover(date, date);
drop function if exists public.sales_ops_dealer_bounce_rate(date, date);
drop function if exists public.ops_reports_made_by_month(date, date);
drop function if exists public.ops_comm_consistency_index(date, date);
drop function if exists public.list_future_sale_opps_open(date, date);
drop function if exists public.list_incoming_stock_by_collection(date, date);
